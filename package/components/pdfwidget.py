...
#         self.ui.pdf_view.setZoomMode(QPdfView.ZoomMode.Custom)
#         self.ui.pdf_view.setZoomFactor(self.zoom)
...
#         self.ui.pdf_view.setZoomMode(QPdfView.ZoomMode.FitToWidth)
#         log.Log.debug_logger("set_zoom_to_fit_width(self)")

#     def set_zoom_to_fit_view(self):
#         self.ui.pdf_view.setZoomMode(QPdfView.ZoomMode.FitInView)
...
#         self.ui.pdf_view.setDocument(self.document)
