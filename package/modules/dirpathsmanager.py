...
class DirPathManager:
    ...
    def set_new_dirpaths_for_project(self):
        log.obj_l.debug_logger("set_new_dirpaths_for_project()")
    ...
    def set_project_dirpath(self, dirpath: str):
        ...
        log.obj_l.debug_logger(f"set_project_dirpath(dirpath: str): dirpath = {dirpath}")
    ...
    def get_logs_dirpath(self) -> str:
        # ТУТ НЕ НУЖЕН log.obj_l.debug_logger()
    ...
    def get_temp_dirpath(self) -> str:
        log.obj_l.debug_logger("get_temp_dirpath() -> str:")
