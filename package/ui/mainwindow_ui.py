...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if QIcon.hasThemeIcon(iconThemeName):
            ...
            icon.addFile(u":/icons/resources/icons/add-file.svg", QSize(), QIcon.Normal, QIcon.Off)

        self.action_new.setIcon(icon)
        self.action_open = QAction(MainWindow)
        self.action_open.setObjectName(u"action_open")
        icon1 = QIcon()
        icon1.addFile(u":/icons/resources/icons/open.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/resources/icons/zoom-in.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/resources/icons/zoom-out.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/resources/icons/text-editor.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/resources/icons/zoom-fit-width.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/resources/icons/export.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/resources/icons/template.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/resources/icons/items-tree.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.scrollarea_inputforms_layout.setGeometry(QRect(0, 0, 671, 635))
